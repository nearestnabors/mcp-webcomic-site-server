...
**Technical file:** `03-mcp-apps-anatomy.md`
...
**Technical file:** `04-webmcp-anatomy.md`
...
**Technical file:** `05-text-vs-data-vs-ui.md`
- Decision framework
...
| `03-mcp-apps-anatomy.md` | How MCP Apps work, bundling, registration |
| `04-webmcp-anatomy.md` | WebMCP API, tool registration, templates |
| `05-text-vs-data-vs-ui.md` | Return type decision framework |
